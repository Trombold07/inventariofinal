...
$(function () {
    ...
    */
    $('select[name="cod_proveedor"]').select2({
        ...
        placeholder: 'Ingrese el numero de cedula del comprador',
        minimumInputLength: 1,
        templateResult: formatRepo
    });

    /**
     * Para el buscador de Productos y agregarlos a la lista 
    */
    ...
    /**
     * Para Agregar nuevo proveedor desde un modal
    */
    ...
    $('#myModalClient').on('hidden.bs.model', function(e) {
    ...
    $('#frmCliente').on('submit', function (e) {
        ...
        registrar_informacion_ajax(window.location.pathname, parameters, function (response) {
            var newOption = new Option(response.full_name, response.id, defaultSelected=false, selected=true);
    ...
    /**
     * Funccion cuando se cambia la cantidad de los productos en la tabla 
    */
