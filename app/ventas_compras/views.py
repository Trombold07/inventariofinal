...
from app.proveedor.forms import RegistrarProveedorForm
...
class FacturaCompraView(ValidatePermissionRequiredMixin, LoginRequiredMixin, CreateView):
        ...
        try:
            ...
            if action == "buscarProductos":
                ...
                with transaction.atomic():
                    ...
                    new_proveedor.cod_proveedor = request.POST.get('cod_proveedor')
                    new_proveedor.nombre = request.POST.get('nombre')
                    new_proveedor.direccion = request.POST.get('direccion')
                    new_proveedor.email = request.POST.get('email')
                    new_proveedor.telefono = request.POST.get('telefono')
                    new_proveedor.save()
    ...
    def get_context_data(self, **kwargs):
        ...
        context['titulo'] = "Compra de Productos"
        context['action'] = 'add'
        context['formProveedor'] = RegistrarProveedorForm()
        return context
