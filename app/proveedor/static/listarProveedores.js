        ...
        columnDefs:[
            {
                ...
                render: function (data, type, row){
                    return '<div class="button-small"><a href="/proveedor/listar/'+ row.id +'/" class="btn btn-warning button-opciones"><i class="fas fa-edit"></i></a>'+
                    '<a href="#" rel="delete" class="btn btn-danger button-opciones"><i class="fas fa-trash-alt"></i></a></div>';
                }
            },
        ],
